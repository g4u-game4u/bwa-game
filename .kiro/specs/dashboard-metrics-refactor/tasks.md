...
- [ ] 5. Remove Processos cards from all views
  - [~] 5.1 Remove processInfo panel from `dados-mes-atual` component
  ...
  - [~] 5.2 Remove processInfo panel from `dados-mes-anterior` component
  ...
  - [~] 5.3 Remove Processos section from `c4u-activity-progress` component
...
- [ ] 6. Implement goal setting for SUPERVISOR and GESTOR
  - [~] 6.1 Expand goal form in `team-management-dashboard.component.ts`
  ...
  - [~] 6.2 Update goal form template in `team-management-dashboard.component.html`
  ...
  - [~] 6.3 Write property test: Goal save API payload structure
  ...
  - [~] 6.4 Write property test: Bulk goal save sends one request per collaborator
  ...
  - [~] 6.5 Write property test: Goal form validation
...
- [ ] 7. Feed dynamic goals into existing KPI circular components
  - [~] 7.1 Update `kpi.service.ts` to read `cnpj_goal` and `entrega_goal` from player extra
  ...
  - [~] 7.2 Update `loadTeamKPIs()` in `team-management-dashboard.component.ts` for dynamic team goals
  ...
  - [~] 7.3 Write property test: Dynamic cnpj_goal target in KPI
  ...
  - [~] 7.4 Write property test: Dynamic entrega_goal target in KPI
  ...
  - [~] 7.5 Write property test: Team cnpj_goal target is sum of members
  ...
  - [~] 7.6 Write property test: Team entrega_goal target is average of members
...
- [~] 9. Verify c4u-kpi-circular-progress component requires no changes
...
- [ ] 10. Final integration and cleanup
  - [~] 10.1 Verify zero references to `player.extra.cnpj` remain in the codebase
  ...
  - [~] 10.2 Verify zero references to `extra.client_goals` remain in the codebase
    - Search all services and components for `client_goals`
    - Remove or update any remaining references
    - _Requirements: 5.1, 5.2_

  - [~] 10.3 Verify zero references to `extra.companies` remain in the codebase
